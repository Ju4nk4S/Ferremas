...
namespace BlogCore.Areas.Identity.Pages.Account.Manage
{
    public class Disable2faModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                throw new InvalidOperationException($"Ocurrió un error inesperado al deshabilitar 2FA.");
            }

            _logger.LogInformation("El usuario con ID '{UserId}' ha deshabilitado 2FA.", _userManager.GetUserId(User));
            StatusMessage = "2FA ha sido deshabilitado. Puedes volver a habilitar 2FA cuando configures una aplicación de autenticación.";
